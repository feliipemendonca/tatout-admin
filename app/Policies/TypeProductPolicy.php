...
class TypeProductPolicy
{
    ...
    {
        return $user->can('typeproduct.list');
    }
    ...
    {
        return $user->can('typeproduct.edit');
    }
    ...
    {
        return $user->can('typeproduct.create');
    }
    ...
    {
        return $user->getRole() == "master" && $user->can('typeproduct.edit') || 
               $user->getRole() == "admin"  && $user->can('typeproduct.edit');
    }
