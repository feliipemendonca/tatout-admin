                    ...
                    {{-- <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu bg-white" aria-labelledby="dropdownMenuButton1">
                                <li>
                                    <a class="dropdown-item" href="{{ route('dashboard.permission.edit', $item->id) }}" title="Editar">
                                        Editar
                                    </a>
                                </li>
                                <li class="d-flex dropdown-item">
                                    @livewire('delete', ['route' => route('dashboard.permission.destroy', $item),'text' => 'Excluir'],key($item->id))
                                </li>
                            </ul>
                        </div>
                    </td> --}}
